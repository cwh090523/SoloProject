...
namespace UI.ViewModel
{
    ...
    public class PlayerInfohModelSO : ScriptableObject
    {
        ...
        private void OnValidate()
        {
            ...
            normalizedStamina = maxStamina > 0 ? currentStamina / (float)maxStamina : 0f;
        }

        public static PlayerInfohModelSO CreateInstanceFromOriginal(PlayerInfohModelSO original)
        {
            PlayerInfohModelSO newInstance = CreateInstance<PlayerInfohModelSO>();
        ...
        public static void RegisterConverters()
        {
            ...
            ConverterGroup staminaBarGroup = new ConverterGroup("Stamina bar Converter");
            staminaBarGroup.AddConverter((ref float normalizedStamina) =>
                new StyleColor(Color.Lerp(Color.red, Color.yellow, normalizedStamina)));
            
            ConverterGroups.RegisterConverterGroup(staminaBarGroup);
